...
Load the `shape` skill and use the user's feature description to produce the design brief.
...
If the user already has a confirmed design brief, skip this step and use it.
