...
**Output**: A design brief that can be handed off to the `impeccable` skill, Claude, or any other implementation skill.
...
Once confirmed, the brief is complete. The user can now hand it to the `impeccable` skill, Claude, or use it to guide any other implementation approach. If the same agent should continue into implementation immediately, switch into the build flow from `impeccable/reference/craft.md`.
